...
export function applyInputCss(size: PaginationSize, disable: boolean | undefined) {
    return css`
...
export function applyJumperInputCss(disable: boolean | undefined, size: PaginationSize) {
    return css`
      margin-left: 14px;
      ${applyTextColor(disable)};
...
export function applyDefaultItemCss(disable: boolean | undefined, size: PaginationSize) {
    return css`
      display: inline-flex;
...
export function applyDefaultItemWithMarginCss(disable: boolean | undefined, size: PaginationSize) {
    return css`
      margin-right: 8px;
...
export function applyBackground(disable: boolean | undefined, selected: boolean | undefined): SerializedStyles | undefined {
    if (!disable && !selected) {
        return css`
          &:hover {
...
export function applyTextColor(disabled: boolean | undefined, selected?: boolean | undefined): SerializedStyles {
    if (!selected){
        if (disabled) {
            return css`
...
export function applyPageNumItemSelectedCss(disabled: boolean | undefined, size: PaginationSize): SerializedStyles {
    return css`
...
export function applyPageSizeSelectorCss(disabled: boolean | undefined, size: PaginationSize) {
