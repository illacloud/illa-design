...
test("Space renders with single size", () => {
  ...
  expect(screen.getByTestId("test-space-single-element-array").parentNode).toHaveStyle({
    "margin-right": "30px",
  })
  expect(screen.getByTestId("test-space-single-element-array-last").parentNode).not.toHaveStyle({
    "margin-right": "30px",
  })
})
...
test("Space renders with size array but without wrap", () => {
  ...
  expect(screen.getByTestId("test-space-with-size-array").parentNode).toHaveStyle({
    "margin-right": "8px",
  })
  expect(screen.getByTestId("test-space-with-size-array").parentNode).not.toHaveStyle({
    "margin-bottom": "16px",
  })
  expect(screen.getByTestId("test-space-with-size-array-last").parentNode).not.toHaveStyle({
    "margin-bottom": "16px",
    "margin-right": "8px",
  })
})
...
test("Space renders with size array and wrap", () => {
  ...
  expect(screen.getByTestId("test-space-with-size-array-last").parentNode).toHaveStyle({
    "margin-bottom": "16px",
  })
  expect(screen.getByTestId("test-space-with-size-array-last").parentNode).not.toHaveStyle({
    "margin-right": "8px",
  ...
  expect(screen.getByTestId("test-space-with-size-array-vertical").parentNode).toHaveStyle({
    "margin-right": "8px",
    "margin-bottom": "16px",
  })
  expect(screen.getByTestId("test-space-with-size-array-last-vertical").parentNode).not.toHaveStyle({
    "margin-bottom": "16px",
  })
  expect(screen.getByTestId("test-space-with-size-array-last-vertical").parentNode).toHaveStyle({
    "margin-right": "8px",
  })
})
...
test("Space renders with empty size array", () => {
  ...
  expect(screen.getByTestId("test-space-with-empty-size-array").parentNode).not.toHaveStyle({
    "margin-right": "8px",
    "margin-bottom": "8px",
  })
})
...
test("Space renders with different direction", () => {
  ...
  expect(screen.getByTestId("test-space-horizontal").parentNode).toHaveStyle("margin-right:8px")
  expect(screen.getByTestId("test-space-vertical").parentNode).toHaveStyle("margin-bottom:8px")
})
