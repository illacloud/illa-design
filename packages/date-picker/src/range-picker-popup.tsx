...
import {
  applyRangeFooterCss, buttonBoxCss,
  horShortcuts,
  nowButtonCss,
  popupCss, rangeBodyCss, rangeLeftContentCss, rangePickerCss, rangeRightContentCss,
  showTimeContainerCss,
  showTimeHeaderCss,
  singlePickerContentCss,
  triContentCommonCss,
  vertShortcuts, wrapCss,
} from "./style"
...
export const RangePickerPopUp = forwardRef<HTMLDivElement, RangePickerPopUpProps>(
  (props, ref) => {
    const {
      shortcuts,
