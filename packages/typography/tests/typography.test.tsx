...
test("Heading renders with different level", () => {
  const { getByTestId } = render(<Typography data-testid="test-typography">
    ...
    <Paragraph>
      ...
      craft work, some engineering, coding, and graphic design) may also be considered{" "}
      <Text bold>to be a design activity.</Text>
    </Paragraph>
    <Heading level="h2">ILLA Design</Heading>
    <Paragraph>
      The ILLA Design component library defines a set of default particle variables, and a custom
    ...
    <Paragraph>
      A design is a plan or specification for the construction of an object or system or for the
      implementation of an activity or process, or the result of that plan or specification in the
      form of a <Text code>prototype</Text>, <Text code>product</Text> or <Text code>process</Text>.
