...
const globalColorNormal: Map<string, string> = new Map([
  ["--illa-blackalpha-01", "#000"],
  ["--illa-blackalpha-02", "rgba(0, 0, 0, 0.88)"],
  ["--illa-blackalpha-03", "rgba(0, 0, 0, 0.64)"],
  ["--illa-blackalpha-04", "rgba(0, 0, 0, 0.4)"],
  ["--illa-blackalpha-05", "rgba(0, 0, 0, 0.24)"],
  ["--illa-blackalpha-06", "rgba(0, 0, 0, 0.16)"],
  ["--illa-blackalpha-07", "rgba(0, 0, 0, 0.12)"],
  ["--illa-blackalpha-08", "rgba(0, 0, 0, 0.08)"],
  ["--illa-blackalpha-09", "rgba(0, 0, 0, 0.04)"],
