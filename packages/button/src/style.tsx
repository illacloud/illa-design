...
export function getDifferentStatusColor(colorScheme: ButtonColorScheme, variant: ButtonVariant, state: State): string[] {
  switch (state) {
    case State.DEFAULT:
      switch (variant) {
        case "fill":
...
export function applyCursor(loading: boolean, disabled: boolean): SerializedStyles {
  if (loading) {
    return css`
      cursor: default;
    `
