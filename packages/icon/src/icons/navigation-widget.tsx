...
export const NavigationWidgetIcon = createIcon({
  title: "NavigationWidgetIcon",
  viewBox: "0 0 72 54",
  path: (
    <>
      ...
      <rect x="50" y="24" width="6" height="6" rx="2" fill="#E0E0E0" />
      <circle cx="19" cy="32" r="1" fill="#C9CDD4" />
    </>
  ),
})

NavigationWidgetIcon.displayName = "NavigationWidgetIcon"
