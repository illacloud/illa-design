...
export const NumberInputWidgetIcon = createIcon({
  title: "NumberInputWidgetIcon",
  viewBox: "0 0 72 54",
  path: (
    <>
      <rect
...
NumberInputWidgetIcon.displayName = "NumberInputWidgetIcon"
