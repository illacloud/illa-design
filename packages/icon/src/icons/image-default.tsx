...
export const ImageDefaultIcon = createIcon({
  ...
  path:
    <g fillRule="evenodd">
      <path fill="currentColor" d="M-78-142H922v842H-78z" />
      <path fillOpacity=".04" fill="currentColor" d="M-38-38H62V62H-38z" />
      ...
      <path
        ...
        fillOpacity=".12" fill="currentColor" fillRule="nonzero" />
    </g>,
})