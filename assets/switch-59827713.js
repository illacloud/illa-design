import{a as S,j as o}from"./emotion-react-jsx-runtime.browser.esm-63b6c831.js";import{r as V}from"./index-c4905b50.js";import{g as i,i as r,c as p,a as I,d as j}from"./style-eba6b849.js";import{d as z}from"./is-6e11be7b.js";const T=["white","blackAlpha","gray","red","orange","yellow","green","blue","cyan","purple","grayBlue","techPurple","techPink"];function _(e,a,u){const l=u==="medium"?"26px":"40px",n=u==="medium"?"16px":"24px",t=T.indexOf(e)>-1;let s=a?t?i(`--${r}-${e}-01`):e:i(`--${r}-grayBlue-06`);return p`
    position: relative;
    border-radius: 16px;
    min-width: ${l};
    height: ${n};
