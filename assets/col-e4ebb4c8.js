import{j as y}from"./emotion-react-jsx-runtime.browser.esm-63b6c831.js";import{r as p}from"./index-c4905b50.js";import{c as a,a as $,d as h}from"./style-eba6b849.js";function O(e,l){return a`
    display: flex;
    flex-direction: row;
    flex-wrap: wrap;
    justify-content: ${l};
    align-items: ${e};
  `}function E(e){if(typeof e=="object"){const{xs:l,sm:n,md:u,lg:i,xl:r,xxl:s}=e;return F(l,n,u,i,r,s)}return a`
    column-gap: ${e};
  `}function A(e){if(typeof e=="object"){const{xs:l,sm:n,md:u,lg:i,xl:r,xxl:s}=e;return J(l,n,u,i,r,s)}return a`
    row-gap: ${e};
  `}function F(e,l,n,u,i,r){return a`
    @media (min-width: 0px) {
      column-gap: ${e};
    }
  ...
  `}function J(e,l,n,u,i,r){return a`
    @media (min-width: 0px) {
      row-gap: ${e};
    }
    @media (min-width: 576px) {
