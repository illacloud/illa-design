import{a as m,j as f}from"./emotion-react-jsx-runtime.browser.esm-1facf72c.js";import{r}from"./index-1cdf6ce0.js";import{c as l,k as x,a as h,d as v}from"./style-3ea54b04.js";import{g as p}from"./color-palette-728b424e.js";import{L as S}from"./loading-be690f19.js";function w(e){return l`
    display: ${e?"inline-flex":"flex"};
    position: relative;
  `}function C(e,a){return l`
    size: ${a==="small"?"12px":"14px"};
    margin-top: 8px;
    line-height: 22px;
    color: ${p(e,"03")};
  `}function c(e,a,t){let n;switch(e){case"small":n=l`
        font-size: 12px;
      `;break;case"large":n=l`
        font-size: 24px;
      `;break;default:n=l`
        font-size: 16px;
      `}const i=a?j:null;return l`
    color: ${p(t,"03")};
    ${i};
    ${n};
  `}function k(e){if(e){let a;return e&&(a=l`
        background-color: ${p("white","03")};
      `),l`
      ${a};
