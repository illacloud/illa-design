import{j as o,a as A}from"./emotion-react-jsx-runtime.browser.esm-63b6c831.js";import{r as i}from"./index-c4905b50.js";import{k as Q,c as p,g as C,i as w,a as Z,d as ee}from"./style-eba6b849.js";import{S as ae}from"./star-fill-434c7b6c.js";import{L as te}from"./like-fill-da69bbe1.js";import{T as re}from"./trigger-b1fdcaa0.js";import{S as ne}from"./space-58565126.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-5b79630f.js";import"./_commonjsHelpers-042e6b4d.js";import"./create-icon-e1f02089.js";import"./color-palette-cd133b87.js";import"./index-d85697b4.js";import"./trigger-context-adc67150.js";import"./index-07d1f67e.js";import"./motion-1a692e5b.js";import"./use-isomorphic-effect-4e0215de.js";import"./animate-83017438.js";import"./index-28b4eed0.js";import"./divider-942251de.js";function W(e,a){return a===void 0&&(a=15),+parseFloat(Number(e).toPrecision(a))}function x(e){var a=e.toString().split(/[eE]/),r=(a[0].split(".")[1]||"").length-+(a[1]||0);return r>0?r:0}function $(e){if(e.toString().indexOf("e")===-1)return Number(e.toString().replace(".",""));var a=x(e);return a>0?W(Number(e)*Math.pow(10,a)):Number(e)}function H(e){(e>Number.MAX_SAFE_INTEGER||e<Number.MIN_SAFE_INTEGER)&&console.warn(e+" is beyond boundary when transfer to integer, the results may not be accurate")}function D(e){return function(){for(var a=[],r=0;r<arguments.length;r++)a[r]=arguments[r];var n=a[0],u=a.slice(1);return u.reduce(function(d,V){return e(d,V)},n)}}var G=D(function(e,a){var r=$(e),n=$(a),u=x(e)+x(a),d=r*n;return H(d),d/Math.pow(10,u)}),le=D(function(e,a){var r=$(e),n=$(a);return H(r),H(n),G(r/n,W(Math.pow(10,x(a)-x(e))))});const ie=Q`
  0% {
    transform: scale(1);
  }
...
`;function se(e){const a=e?p`
  ...
  flex-wrap: wrap;
  gap: 7px;
`;function ue(e,a,r){const n=e||a?"":"cursor: pointer",u=r?p`
...
//# sourceMappingURL=rate.stories-e9e57281.js.map
