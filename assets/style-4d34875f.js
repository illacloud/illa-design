import{c as e}from"./style-eba6b849.js";import{g as r}from"./color-palette-cd133b87.js";const p=t=>{switch(t){case"small":return e`
        font-size: 12px;
        padding: 1px 12px;
      `;case"large":return e`
        font-size: 14px;
  ...
  &:hover {
    border-color: ${r("red","02")};
    background-color: ${r("red","06")};
  }
`,n=e`
  color: ${r("grayBlue","05")};
...
//# sourceMappingURL=style-4d34875f.js.map
