...
`,W=e=>{switch(e){case"small":return a`
  ...
  `}const G=e=>{switch(e){case"small":return a`
      ...
      `;break;case"large":r=a`
        padding: 9px 16px;
        height: 36px;
      `;break}const u=n==="gray"||n==="grayBlue"?i(`--${t}-${n}-02`):o(n,"03");e!=null&&e.disabled&&(e!=null&&e.checked)?l=a`
      color: ${o(n,"06")};
      cursor: not-allowed;
