...
`,qe=(e,a)=>{let t;switch(e){default:case"line":t="0px 12px";break;case"text":case"capsule":t="0";break}return r`
      ...
      padding: ${t};
      /* cursor: pointer; */
    `},Ve=(e,a,t,l,n)=>{let u="row";a==="left"&&(u="row-reverse");let s;n&&(s=`
    background-color: ${m("white","01")};
    `);let d;return l?d=r`
      cursor: not-allowed;
    `:n?d=r`
...
//# sourceMappingURL=tabs.stories-ef4b883c.js.map
