import{j as m,a as f}from"./emotion-react-jsx-runtime.browser.esm-63b6c831.js";import{r}from"./index-c4905b50.js";import{c as n,k as x,a as h,d as v}from"./style-eba6b849.js";import{g as p}from"./color-palette-cd133b87.js";import{L as S}from"./loading-6ba90f9e.js";function w(e){return n`
    display: ${e?"inline-flex":"flex"};
    position: relative;
  `}function C(e,a){return n`
    size: ${a==="small"?"12px":"14px"};
    margin-top: 8px;
    line-height: 22px;
    color: ${p(e,"03")};
  `}function c(e,a,t){let l;switch(e){case"small":l=n`
        font-size: 12px;
      `;break;case"large":l=n`
        font-size: 24px;
      `;break;default:l=n`
        font-size: 16px;
      `}const i=a?j:null;return n`
    color: ${p(t,"03")};
    ${i};
    ${l};
  `}function k(e){if(e){let a;return e&&(a=n`
