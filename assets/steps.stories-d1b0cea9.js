import{j as n,a as h}from"./emotion-react-jsx-runtime.browser.esm-63b6c831.js";import{r as w}from"./index-c4905b50.js";import{c as i,d as k,a as D}from"./style-eba6b849.js";import{g as a}from"./color-palette-cd133b87.js";import{E as j}from"./error-c35e0565.js";import{S as R}from"./success-e9a4a46c.js";import{N as H}from"./next-04b59426.js";import{u as T}from"./use-merge-value-460a468d.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-5b79630f.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-d85697b4.js";import"./create-icon-e1f02089.js";import"./is-6e11be7b.js";import"./use-previous-c448b133.js";function L(e){return i`
    display: flex;
  ...
  height: 24px;
  font-size: 24px;
`;function E(e){let t;switch(e){case"wait":t=a("grayBlue","06");break;case"process":case"finish":t=a("blue","03");break;case"error":t=a("red","03");break}return i`
    border-radius: 4px;
    flex-shrink: 0;
    width: 8px;
    height: 8px;
  ...
  `}function x(e){let t=i``;switch(e){case"wait":t=i`
    ...
    border-radius: 12px;
    ${t};
  `}function G(e,t,l){let r=i``;return e==="vertical"&&!t&&(r=i`
      margin-bottom: 16px;
    `),i`
...
`,M=i`
  ...
  text-overflow: ellipsis;
  color: ${a("grayBlue","04")};
`;function A(e,t){let l=i``;switch(e){case"finish":case"wait":l=i`
        border-color: transparent;
      `;break;case"process":l=i`
        border-color: ${t?"transparent":a("blue","03")};
      `;break;case"error":l=i`
...
`,ne=i`
  ...
  margin-bottom: 8px;
  flex-grow: 1;
`;function te(e,t,l){let r=i``;switch(e){case"wait":r=i`
        border-color: ${l?"transparent":a("grayBlue","08")};
      `;break;case"process":r=i`
        border-color: ${l?"transparent":a("white","01")};
      `;break;case"finish":r=i`
        border-color: ${l?"transparent":a("blue","03")};
      `;break;case"error":r=i`
        border-color: ${l?"transparent":a("red","03")};
      `;break}return i`
    margin-top: 4px;
    margin-left: ${t==="dot"?"3px":"11px"};
    border-left: 1px solid;
    ${r};
  `}function ae(e){return i`
    margin-right: 16px;
    word-wrap: break-word;
    white-space: pre;
    ...
    font-size: 12px;
    color: ${a("grayBlue","04")};
  `}const $=w.forwardRef((e,t)=>{const{icon:l,status:r="wait",index:f=0,disabled:b,lineStatus:V="wait",lineless:p,canClick:q,description:v,title:c,type:g="dot",last:y,direction:d,...s}=e,m=w.useMemo(()=>{let u=null;switch(g){case"dot":u=n("div",{css:E(r)});break;case"line":switch(r){case"wait":u=n("div",{css:x(r),children:f+1});break;case"process":u=n("div",{css:x(r),children:f+1});break;case"finish":u=n("div",{css:x(r),children:n(R,{c:a("blue","03")})});break;case"error":u=n("div",{css:x(r),children:n(j,{c:a("red","03")})});break}break}return l?n("span",{css:P,children:l}):u},[g,l,f,r]);return d==="horizontal"?h("div",{ref:t,css:O(q,b,y),...k(s),children:[h("div",{css:K,children:[m,n("div",{css:Q,children:c}),!y&&n("div",{css:U(V,p)})]}),v&&n("div",{css:J(g),children:v})]}):h("div",{ref:t,css:Z(q,b,y),...k(s),children:[h("div",{css:ee,children:[m,n("div",{css:ie,children:c})]}),h("div",{css:ne,children:[!y&&n("div",{css:te(V,g,p)}),v&&n("div",{css:ae(g),children:v})]})]})});$.displayName="DotStep";try{$.displayName="DotStep",$.__docgenInfo={description:"",displayName:"DotStep",props:{lineStatus:{defaultValue:null,description:"",name:"lineStatus",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"wait"'},{value:'"process"'},{value:'"finish"'}]}},lineless:{defaultValue:null,description:"",name:"lineless",required:!1,type:{name:"boolean"}},canClick:{defaultValue:null,description:"",name:"canClick",required:!1,type:{name:"boolean"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactNode"}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean"}},status:{defaultValue:null,description:"",name:"status",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"wait"'},{value:'"process"'},{value:'"finish"'}]}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"ReactNode"}},title:{defaultValue:null,description:"",name:"title",required:!1,type:{name:"ReactNode"}},index:{defaultValue:null,description:"",name:"index",required:!1,type:{name:"number"}},type:{defaultValue:null,description:"",name:"type",required:!1,type:{name:"enum",value:[{value:'"navigation"'},{value:'"dot"'},{value:'"line"'}]}},direction:{defaultValue:null,description:"",name:"direction",required:!1,type:{name:"enum",value:[{value:'"horizontal"'},{value:'"vertical"'}]}},last:{defaultValue:null,description:"",name:"last",required:!1,type:{name:"boolean"}},w:{defaultValue:null,description:"width",name:"w",required:!1,type:{name:"string"}},maxW:{defaultValue:null,description:"max-width",name:"maxW",required:!1,type:{name:"string"}},minW:{defaultValue:null,description:"min-width",name:"minW",required:!1,type:{name:"string"}},h:{defaultValue:null,description:"height",name:"h",required:!1,type:{name:"string"}},maxH:{defaultValue:null,description:"max-height",name:"maxH",required:!1,type:{name:"string"}},minH:{defaultValue:null,description:"min-height",name:"minH",required:!1,type:{name:"string"}},pd:{defaultValue:null,description:"padding",name:"pd",required:!1,type:{name:"string"}},pt:{defaultValue:null,description:"padding-top",name:"pt",required:!1,type:{name:"string"}},pb:{defaultValue:null,description:"padding-bottom",name:"pb",required:!1,type:{name:"string"}},pl:{defaultValue:null,description:"padding-left",name:"pl",required:!1,type:{name:"string"}},pr:{defaultValue:null,description:"padding-right",name:"pr",required:!1,type:{name:"string"}},mg:{defaultValue:null,description:"margin",name:"mg",required:!1,type:{name:"string"}},ml:{defaultValue:null,description:"margin-left",name:"ml",required:!1,type:{name:"string"}},mr:{defaultValue:null,description:"margin-right",name:"mr",required:!1,type:{name:"string"}},mt:{defaultValue:null,description:"margin-top",name:"mt",required:!1,type:{name:"string"}},mb:{defaultValue:null,description:"margin-bottom",name:"mb",required:!1,type:{name:"string"}},bd:{defaultValue:null,description:"border",name:"bd",required:!1,type:{name:"string"}},bdRadius:{defaultValue:null,description:"border-radius",name:"bdRadius",required:!1,type:{name:"string"}},bt:{defaultValue:null,description:"border-top",name:"bt",required:!1,type:{name:"string"}},bl:{defaultValue:null,description:"border-left",name:"bl",required:!1,type:{name:"string"}},bb:{defaultValue:null,description:"border-bottom",name:"bb",required:!1,type:{name:"string"}},br:{defaultValue:null,description:"border-right",name:"br",required:!1,type:{name:"string"}},bg:{defaultValue:null,description:"background",name:"bg",required:!1,type:{name:"string"}},bdColor:{defaultValue:null,description:"border-color",name:"bdColor",required:!1,type:{name:"string"}},bgColor:{defaultValue:null,description:"background-color",name:"bgColor",required:!1,type:{name:"string"}},c:{defaultValue:null,description:"color",name:"c",required:!1,type:{name:"string"}},opac:{defaultValue:null,description:"opacity",name:"opac",required:!1,type:{name:"number"}},pos:{defaultValue:null,description:"",name:"pos",required:!1,type:{name:"enum",value:[{value:'"absolute"'},{value:'"relative"'},{value:'"fixed"'},{value:'"static"'}]}},posT:{defaultValue:null,description:"",name:"posT",required:!1,type:{name:"string"}},posL:{defaultValue:null,description:"",name:"posL",required:!1,type:{name:"string"}},posB:{defaultValue:null,description:"",name:"posB",required:!1,type:{name:"string"}},posR:{defaultValue:null,description:"",name:"posR",required:!1,type:{name:"string"}},z:{defaultValue:null,description:"",name:"z",required:!1,type:{name:"string | number"}},ov:{defaultValue:null,description:"over-flow,over-flow-x,over-flow-y",name:"ov",required:!1,type:{name:"string"}},ovX:{defaultValue:null,description:"",name:"ovX",required:!1,type:{name:"string"}},ovY:{defaultValue:null,description:"",name:"ovY",required:!1,type:{name:"string"}},v:{defaultValue:null,description:"visibility",name:"v",required:!1,type:{name:"string"}},alignItems:{defaultValue:null,description:"",name:"alignItems",required:!1,type:{name:"string"}},alignContent:{defaultValue:null,description:"",name:"alignContent",required:!1,type:{name:"string"}},justifyItems:{defaultValue:null,description:"",name:"justifyItems",required:!1,type:{name:"string"}},justifyContent:{defaultValue:null,description:"",name:"justifyContent",required:!1,type:{name:"string"}},flexWrap:{defaultValue:null,description:"",name:"flexWrap",required:!1,type:{name:"string"}},flexDirection:{defaultValue:null,description:"",name:"flexDirection",required:!1,type:{name:"string"}},flex:{defaultValue:null,description:"",name:"flex",required:!1,type:{name:"string"}},flexGrow:{defaultValue:null,description:"",name:"flexGrow",required:!1,type:{name:"string"}},flexShrink:{defaultValue:null,description:"",name:"flexShrink",required:!1,type:{name:"string"}},flexBasis:{defaultValue:null,description:"",name:"flexBasis",required:!1,type:{name:"string"}},justifySelf:{defaultValue:null,description:"",name:"justifySelf",required:!1,type:{name:"string"}},alignSelf:{defaultValue:null,description:"",name:"alignSelf",required:!1,type:{name:"string"}},o:{defaultValue:null,description:"order",name:"o",required:!1,type:{name:"string"}},_css:{defaultValue:null,description:"",name:"_css",required:!1,type:{name:"SerializedStyles"}},fs:{defaultValue:null,description:"font-size",name:"fs",required:!1,type:{name:"string"}},ff:{defaultValue:null,description:"font-family",name:"ff",required:!1,type:{name:"string"}},fw:{defaultValue:null,description:"font-weight",name:"fw",required:!1,type:{name:"string"}},cur:{defaultValue:null,description:"",name:"cur",required:!1,type:{name:"string"}}}}}catch{}const o=w.forwardRef((e,t)=>{const{children:l,direction:r="horizontal",lineless:f,current:b,type:V="dot",items:p,onChange:q,...v}=e,[c,g]=T(-1,{value:b,defaultValue:0}),y=w.useCallback((d,s)=>{s||(b===void 0&&g(d),q==null||q(d))},[b,q,g]);return n("div",{css:[L(r),D(e)],ref:t,...k(v),children:p&&p.map((d,s)=>{let m="wait";d.status===void 0?m=c>s?"finish":c===s?"process":"wait":m=d.status;let u=c>s?"finish":"wait";switch(s+1<p.length&&(u=p[s+1].status==="error"?"error":u),V){case"navigation":return n(C,{status:m,lineless:f||s!==c,last:s===p.length-1,canClick:!0,lineStatus:m,icon:d.icon,disabled:d.disabled,type:V,direction:r,description:d.description,title:d.title,index:s,onClick:()=>{y(s,d.disabled)}},s);case"dot":case"line":default:return n($,{status:m,lineless:f,last:s===p.length-1,canClick:!1,lineStatus:u,icon:d.icon,disabled:d.disabled,type:V,direction:r,description:d.description,title:d.title,index:s,onClick:()=>{y(s,d.disabled)}},s)}})})});o.displayName="Steps";try{o.displayName="Steps",o.__docgenInfo={description:"",displayName:"Steps",props:{lineless:{defaultValue:null,description:"",name:"lineless",required:!1,type:{name:"boolean"}},current:{defaultValue:null,description:"",name:"current",required:!1,type:{name:"number"}},items:{defaultValue:null,description:"",name:"items",required:!1,type:{name:"StepItem[]"}},direction:{defaultValue:null,description:"",name:"direction",required:!1,type:{name:"enum",value:[{value:'"horizontal"'},{value:'"vertical"'}]}},type:{defaultValue:null,description:"",name:"type",required:!1,type:{name:"enum",value:[{value:'"navigation"'},{value:'"dot"'},{value:'"line"'}]}},onChange:{defaultValue:null,description:"",name:"onChange",required:!1,type:{name:"((current: number) => void)"}},w:{defaultValue:null,description:"width",name:"w",required:!1,type:{name:"string"}},maxW:{defaultValue:null,description:"max-width",name:"maxW",required:!1,type:{name:"string"}},minW:{defaultValue:null,description:"min-width",name:"minW",required:!1,type:{name:"string"}},h:{defaultValue:null,description:"height",name:"h",required:!1,type:{name:"string"}},maxH:{defaultValue:null,description:"max-height",name:"maxH",required:!1,type:{name:"string"}},minH:{defaultValue:null,description:"min-height",name:"minH",required:!1,type:{name:"string"}},pd:{defaultValue:null,description:"padding",name:"pd",required:!1,type:{name:"string"}},pt:{defaultValue:null,description:"padding-top",name:"pt",required:!1,type:{name:"string"}},pb:{defaultValue:null,description:"padding-bottom",name:"pb",required:!1,type:{name:"string"}},pl:{defaultValue:null,description:"padding-left",name:"pl",required:!1,type:{name:"string"}},pr:{defaultValue:null,description:"padding-right",name:"pr",required:!1,type:{name:"string"}},mg:{defaultValue:null,description:"margin",name:"mg",required:!1,type:{name:"string"}},ml:{defaultValue:null,description:"margin-left",name:"ml",required:!1,type:{name:"string"}},mr:{defaultValue:null,description:"margin-right",name:"mr",required:!1,type:{name:"string"}},mt:{defaultValue:null,description:"margin-top",name:"mt",required:!1,type:{name:"string"}},mb:{defaultValue:null,description:"margin-bottom",name:"mb",required:!1,type:{name:"string"}},bd:{defaultValue:null,description:"border",name:"bd",required:!1,type:{name:"string"}},bdRadius:{defaultValue:null,description:"border-radius",name:"bdRadius",required:!1,type:{name:"string"}},bt:{defaultValue:null,description:"border-top",name:"bt",required:!1,type:{name:"string"}},bl:{defaultValue:null,description:"border-left",name:"bl",required:!1,type:{name:"string"}},bb:{defaultValue:null,description:"border-bottom",name:"bb",required:!1,type:{name:"string"}},br:{defaultValue:null,description:"border-right",name:"br",required:!1,type:{name:"string"}},bg:{defaultValue:null,description:"background",name:"bg",required:!1,type:{name:"string"}},bdColor:{defaultValue:null,description:"border-color",name:"bdColor",required:!1,type:{name:"string"}},bgColor:{defaultValue:null,description:"background-color",name:"bgColor",required:!1,type:{name:"string"}},c:{defaultValue:null,description:"color",name:"c",required:!1,type:{name:"string"}},opac:{defaultValue:null,description:"opacity",name:"opac",required:!1,type:{name:"number"}},pos:{defaultValue:null,description:"",name:"pos",required:!1,type:{name:"enum",value:[{value:'"absolute"'},{value:'"relative"'},{value:'"fixed"'},{value:'"static"'}]}},posT:{defaultValue:null,description:"",name:"posT",required:!1,type:{name:"string"}},posL:{defaultValue:null,description:"",name:"posL",required:!1,type:{name:"string"}},posB:{defaultValue:null,description:"",name:"posB",required:!1,type:{name:"string"}},posR:{defaultValue:null,description:"",name:"posR",required:!1,type:{name:"string"}},z:{defaultValue:null,description:"",name:"z",required:!1,type:{name:"string | number"}},ov:{defaultValue:null,description:"over-flow,over-flow-x,over-flow-y",name:"ov",required:!1,type:{name:"string"}},ovX:{defaultValue:null,description:"",name:"ovX",required:!1,type:{name:"string"}},ovY:{defaultValue:null,description:"",name:"ovY",required:!1,type:{name:"string"}},v:{defaultValue:null,description:"visibility",name:"v",required:!1,type:{name:"string"}},alignItems:{defaultValue:null,description:"",name:"alignItems",required:!1,type:{name:"string"}},alignContent:{defaultValue:null,description:"",name:"alignContent",required:!1,type:{name:"string"}},justifyItems:{defaultValue:null,description:"",name:"justifyItems",required:!1,type:{name:"string"}},justifyContent:{defaultValue:null,description:"",name:"justifyContent",required:!1,type:{name:"string"}},flexWrap:{defaultValue:null,description:"",name:"flexWrap",required:!1,type:{name:"string"}},flexDirection:{defaultValue:null,description:"",name:"flexDirection",required:!1,type:{name:"string"}},flex:{defaultValue:null,description:"",name:"flex",required:!1,type:{name:"string"}},flexGrow:{defaultValue:null,description:"",name:"flexGrow",required:!1,type:{name:"string"}},flexShrink:{defaultValue:null,description:"",name:"flexShrink",required:!1,type:{name:"string"}},flexBasis:{defaultValue:null,description:"",name:"flexBasis",required:!1,type:{name:"string"}},justifySelf:{defaultValue:null,description:"",name:"justifySelf",required:!1,type:{name:"string"}},alignSelf:{defaultValue:null,description:"",name:"alignSelf",required:!1,type:{name:"string"}},o:{defaultValue:null,description:"order",name:"o",required:!1,type:{name:"string"}},_css:{defaultValue:null,description:"",name:"_css",required:!1,type:{name:"SerializedStyles"}},fs:{defaultValue:null,description:"font-size",name:"fs",required:!1,type:{name:"string"}},ff:{defaultValue:null,description:"font-family",name:"ff",required:!1,type:{name:"string"}},fw:{defaultValue:null,description:"font-weight",name:"fw",required:!1,type:{name:"string"}},cur:{defaultValue:null,description:"",name:"cur",required:!1,type:{name:"string"}}}}}catch{}const Ve={title:"NAVIGATION/Steps",component:o},F=e=>h("div",{style:{display:"flex",flexDirection:"column"},children:[n(o,{...e,style:{width:850},type:"dot",items:[{title:"Finished",description:"Finished"},{title:"In Progress",status:"error"},{title:"Waiting"}]}),n(o,{...e,style:{width:850,marginTop:"20px"},type:"line",items:[{title:"Finished",description:"Finished"},{title:"In Progress"},{title:"Waiting"}]}),n(o,{...e,style:{width:850,marginTop:"20px"},type:"navigation",items:[{title:"Finished",description:"Finished"},{title:"In Progress",status:"error"},{title:"Waiting"}]}),n(o,{...e,style:{width:850,marginTop:"20px"},type:"navigation",items:[{title:"Finished",description:"FinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinishedFinished"},{title:"In Progress"},{title:"Waiting"}]})]}),S=e=>h("div",{style:{display:"flex",flexDirection:"row"},children:[n(o,{...e,style:{height:300},direction:"vertical",type:"dot",items:[{title:"Finished",description:"Finished"},{title:"In Progress",status:"error"},{title:"Waiting"}]}),n(o,{...e,style:{height:300,marginLeft:"20px"},direction:"vertical",type:"line",items:[{title:"Finished",description:"Finished"},{title:"In Progress"},{title:"Waiting"}]}),n(o,{...e,style:{height:300,marginLeft:"20px"},direction:"vertical",type:"navigation",items:[{title:"Finished",description:"Finished"},{title:"In Progress",status:"error"},{title:"Waiting"}]}),n(o,{...e,style:{height:300,marginLeft:"20px"},direction:"vertical",type:"navigation",items:[{title:"Finished",description:"Finished"},{title:"In Progress"},{title:"Waiting"}]})]});var I,z,W;F.parameters={...F.parameters,docs:{...(I=F.parameters)==null?void 0:I.docs,source:{originalSource:`args => {
  return <div style={{
    display: "flex",
...
}`,...(B=(N=S.parameters)==null?void 0:N.docs)==null?void 0:B.source}}};const qe=["Basic","Vertical"];export{F as Basic,S as Vertical,qe as __namedExportsOrder,Ve as default};
//# sourceMappingURL=steps.stories-d1b0cea9.js.map
