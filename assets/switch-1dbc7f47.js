import{j as S,a as o}from"./emotion-react-jsx-runtime.browser.esm-1facf72c.js";import{r as V}from"./index-1cdf6ce0.js";import{g as r,i as u,c as p,a as I,d as j}from"./style-4011d251.js";import{a as T}from"./color-palette-2f9095e4.js";import{d as z}from"./is-47f46886.js";const _=["white","blackAlpha","gray","red","orange","yellow","green","blue","cyan","purple","grayBlue","techPurple","techPink"];function B(e,a,i){const l=i==="medium"?"26px":"40px",n=i==="medium"?"16px":"24px",t=_.indexOf(e)>-1;let s=a?t?T(e):e:r(`--${u}-grayBlue-06`);return p`
    position: relative;
    border-radius: 16px;
    min-width: ${l};
    height: ${n};
    ...
    &:disabled {
      cursor: not-allowed;
      background-color: ${t&&a?r(`--${u}-${e}-07`):r(`--${u}-grayBlue-08`)};
      color: ${t&&a?r(`--${u}-${e}-07`):r(`--${u}-grayBlue-08`)};
    }
  `}function R(e,a,i){const l=e==="medium"?"12px":"16px",n=e==="medium"?"2px":"4px",t=a?`
        left: 100%;
        margin-left: -${n};
        transform:translateX(-100%)
      `:`left:${n}`,s=i?"":`box-shadow:0 1px 2px ${r(`--${u}-blackAlpha-05`)}`;return p`
    display: flex;
    ...
    border-radius: 50%;
    ${s};
    background-color: ${r(`--${u}-white-01`)};
    transition: all 0.2s ease-in-out;
  `}function N(e,a){const i=a==="medium"?`
          font-size: 12px;
          line-height: 1
        `:`
          font-size:14px;
