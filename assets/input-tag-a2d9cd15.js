import{j as d,F as ue,a as M}from"./emotion-react-jsx-runtime.browser.esm-63b6c831.js";import{r as w}from"./index-c4905b50.js";import{c as l,a as se,d as de}from"./style-eba6b849.js";import{g as i,a as oe}from"./color-palette-cd133b87.js";import{z as Y}from"./z-index-efffafd0.js";import{u as pe}from"./web-3bc7a696.js";import{T as fe}from"./tag-d4c2a659.js";import{u as J}from"./use-merge-value-460a468d.js";import{C as ce}from"./clear-972f4ed5.js";function me(r,n){return l`
    width: ${n}px;
    font-size: inherit;
    background: none;
    outline: none;
  ...
  `}function Z(r){let n=l``;switch(r){case"small":n=l`
      ...
      `;break;case"large":n=l`
        padding: 8px 16px;
      `;break}return n}function ye(r,n,m,S,$,u,q){let b=l``;return S||(b=l`
      &:hover {
        border-color: ${m?i("red","02"):i(n,"06")};
    ...
    border-radius: ${$?"0":q[0]}
      ...
      ${$?"0":q[3]};
    border: 1px solid
      ${m?i("red","03"):i("grayBlue","08")};
    flex-grow: 1;
    flex-shrink: 1;
    background-color: ${S?i("grayBlue","09"):"unset"};
    ${Z(r)};
    ${b};
  `}const be=l`
  display: flex;
...
`;function qe(){return l`
    ...
    box-sizing: border-box;
    font-size: 14px;
  `}const P=w.forwardRef((r,n)=>{const{colorScheme:m="blue",autoFocus:S,allowClear:$,disabled:u,error:q,readOnly:b,saveOnBlur:ee,placeholder:le,inputValue:B,size:o="medium",prefix:L,suffix:W,defaultValue:A,value:p,onBlur:E,onFocus:R,onChange:t,validate:T,onClear:j,onInputChange:C,onKeyDown:z,onPressEnter:O,onRemove:V,renderItem:k,addBefore:F,bdRadius:H,inputTagRef:ae,addAfter:_,labelInValue:f,...D}=r;let a=(H==null?void 0:H.split(" "))??["8px","8px","8px","8px"];a.length==2?a=[a[0],a[1],a[0],a[1]]:a.length==3&&(a=[a[0],a[1],a[2],a[1]]);const[ne,K]=w.useState(!1),[s,v]=J([],{defaultValue:A,value:p}),[x,G]=J("",{defaultValue:"",value:B}),[te,re]=pe(),I=w.useRef(null),N=w.useRef(!1);w.useImperativeHandle(ae,()=>({focus:()=>{var e;return(e=I.current)==null?void 0:e.focus()}}),[]);const ie=w.useMemo(()=>d(ue,{children:s.map((e,h)=>{let g;return f?e.closeable===void 0?g=!b:g=e.closeable:g=!b,u&&(g=!1),d(fe,{css:Ve,visible:!0,size:o,colorScheme:"grayBlue",variant:"light",closable:g,onClose:c=>{const y=[...s];y.splice(h,1),p===void 0&&v(y),t==null||t(y),V==null||V(e,h,c)},children:(k==null?void 0:k(e))??(f?e.label:e)},f?e.label:`${h.toString()}:${p}`)})}),[s,f,u,p,o,k,b,V,t,v]),X=()=>{if(x!==""){let e;f?e=[...s,{label:s.length.toString(),value:x,closeable:!0}]:e=[...s,x],p===void 0&&v(e),B===void 0&&G(""),t==null||t(e)}};return M("div",{css:[qe(),se(D)],ref:n,...de(D),children:[F&&d("span",{css:Q(o,u??!1,l`
                margin-right: -1px;
                border-radius: ${a[0]} 0 0 ${a[3]};
              `),children:F}),M("div",{css:[ye(o,m,q??!1,u??!1,F!==void 0,_!==void 0,a)],onClick:()=>{var e;(e=I.current)==null||e.focus()},children:[L&&d("span",{css:U(u??!1,l`
                  margin-right: ${o==="small"?"8px":"12px"};
                `),children:L}),M("div",{css:be,children:[s.length>0||ne?ie:d("div",{css:ge(o),children:le}),d("input",{disabled:u,ref:I,autoFocus:S,readOnly:b,css:me(o,re.width+12),onChange:e=>{B===void 0&&G(e.currentTarget.value),C==null||C(e.currentTarget.value)},onBlur:e=>{ee&&X(),E==null||E(e),K(!1)},onFocus:e=>{R==null||R(e),K(!0)},value:x,onCompositionStart:()=>{N.current=!0},onCompositionEnd:()=>{N.current=!1},onKeyDown:async e=>{var h,g;if(!N.current&&(z==null||z(e),e.key==="Enter"&&((h=I.current)==null||h.focus(),O==null||O(e),(await(T==null?void 0:T(x,s))||T===void 0)&&X()),e.key==="Backspace"&&x==="")){(g=I.current)==null||g.focus();let c;f?c=[...s]:c=[...s];const y=c.pop();p===void 0&&v(c),y&&(V==null||V(y,c.length,e)),t==null||t(c)}}},"inputTagInput")]}),$&&!u&&s.length>0&&d(ce,{className:"clear",flexShrink:"0",onClick:e=>{e.stopPropagation(),j==null||j(),p===void 0&&v([]),t==null||t([])},cursor:"pointer",fs:"12px",ml:"4px",c:i("grayBlue","06")}),W&&d("span",{css:U(u??!1,l`
                  margin-left: ${o==="small"?"8px":"12px"};
                `),children:W}),d("span",{ref:te,css:xe,children:x.replace(/\s/g," ")})]}),_&&d("span",{css:Q(o,u??!1,l`
                margin-left: -1px;
...
//# sourceMappingURL=input-tag-a2d9cd15.js.map
